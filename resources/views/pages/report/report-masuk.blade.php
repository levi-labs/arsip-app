        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <div id="showError" class="alert alert-warning showError"> <b>Field Tanggal Dari | Tanggal Sampai is
                            required</b></div>
                        ...
                        <div class="col-md-6">
                            ...
                            <form id="my-Form" method="POST" autocomplete="off">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="input-dari" aria-describedby="emailHelp"
                                        name="input_from">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="input-to" aria-describedby="emailHelp"
                                        name="input_to">
                                </div>
